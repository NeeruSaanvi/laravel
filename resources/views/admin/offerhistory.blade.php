...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span>Restaurant Wise Coupons</span>
        </li>
    </ul>
</div>
 <!-- END PAGE BAR -->
  <!-- BEGIN PAGE TITLE-->
  <h1 class="page-title"> Restaurant Wise Coupons
  </h1>
  <!-- END PAGE TITLE-->
     <!-- END PAGE HEADER-->
        ...
        <div class="row">
         <div class="col-sm-12">
            <div class="portlet-body form">
                <form class="form-material form-horizontal" method="get" action="/admin/useroffer">
                             <div class="form-actions">
                    <div class="form-group col-sm-3">
                        <label class="col-md-12" for="description">Restaurant</span></label>
                        <div class="col-md-12">
                            <select class="form-control" name="username">
                                <option value="">Select</option>
                                @foreach($user_all as $user)
                                    <option value="{{$user->username}}" {{(old('username')?e(old('username')):$username)== $user->username?'selected':''}}>{{$user->rest_name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
    ...
    <div class="portlet box blue">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-globe"></i>Restaurant Wise Coupons</div>
            <div class="tools"> </div>
        </div>
                   ...
                   <tr>
                    ...
                    <td>
                        @if($offer->redeem_by==null)
                         @if($offer->status)
                            <a href="/admin/useroffer/delete/{{ $offer->id }}"><i class="fa fa-trash"></i></a>
                          @else
