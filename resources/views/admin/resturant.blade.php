     ...
     <!-- END PAGE HEADER-->
		 ...
		 <div class="col-sm-12">
            <div class="portlet-body form">
                @if($action!='edit')
                    <form class="form-horizontal" method="post" action="/admin/resturant"  enctype="multipart/form-data">
                @else
                    <form class="form-horizontal" method="post" action="/admin/resturant/{{$resturant->username}}"  enctype="multipart/form-data">
                @endif
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input name="working_hours_to" class="form-control timepicker  timepicker-24" value="{{old('working_hours_to')?e(old('working_hours_to')):$resturant->working_hours_to}}"  required>
                        </div>
                   ...
                   <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input name="website" class="form-control validate[custom[url]]" value="{{old('website')?e(old('website')):$resturant->website}}"  required>
                        </div>
                    </div>
                   <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="col-md-12" for="description">Admin Notes</span></label>
                        <div class="col-md-12">
                            <textarea name="notes" class="form-control">{{old('notes')?e(old('notes')):$resturant->notes}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input type="email" name="email" class="email form-control validate[required,custom[email]]" value="{{old('email')?e(old('email')):$resturant->email}}" @if($action=='edit') readonly="readonly" @endif required>
                            <span class="help-block alert-danger hide">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                         ...
                         <div class="form-group">
                            <div class="col-md-12">
                                <p><input type="checkbox" name="status" value="1" @if($resturant->status == 1) checked @endif>&nbsp;&nbsp;&nbsp;Active<span></span></p>
                            </div>
                        </div>  
