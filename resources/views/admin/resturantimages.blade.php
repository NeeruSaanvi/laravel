     ...
     <!-- END PAGE HEADER-->
		 ...
		 <div class="col-sm-12">
            <div class="portlet-body form">
                @if($action!='edit')
                    <form class="form-horizontal" method="post" action="/admin/resturant_images"  enctype="multipart/form-data">
                @else
                    <form class="form-horizontal" method="post" action="/admin/resturant_images/{{$resturant->id}}"  enctype="multipart/form-data">
                @endif
            ...
            <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" cellspacing="0" width="100%">
                ...
                <tbody>
                   ...
                   <tr>
                    ...
                    <td>
                        <a href="/admin/resturant_images/delete/{{ $rest->id }}"> <i class="fa fa-trash"></i></a>
                         &nbsp;&nbsp; |&nbsp;&nbsp;
                        <a href="/admin/resturant_images/{{ $rest->id }}" class="text-info"> <i class="fa fa-pencil"></i></a></td>
                  </tr>
                    @endforeach
