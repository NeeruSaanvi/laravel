...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Restaurant | @yield('page_title')</title>
                    ...
                    <div class="top-menu">
                        <ul class="nav navbar-nav pull-right">
                            ...
                            <!-- DOC: Remove "dropdown-hoverable" and add data-toggle="dropdown" data-hover="dropdown" data-close-others="true" attributes to the below A element with dropdown-toggle class -->
                             <li class="dropdown">
                                <a href="/resturant/notifications" class="dropdown-toggle">
                                    <i class="icon-bell"></i>
                            ...
                            <li class="dropdown dropdown-user">
                                ...
                                <ul class="dropdown-menu dropdown-menu-default">
                                    <!-- <li>
                                        <a href="/resturant/messages_received">
                                            <i class="icon-envelope-open"></i> My Inbox
                                        </a>
                                    </li> -->
                                     <li><a href="/resturant/change_pwd"><i class="icon-key"></i>  Change Password</a></li>
                                     <li class="divider"> </li>
                                    <li>
                                        <a href="/logout">
                        ...
                        id="side-menu">
                            ...
                            <!-- DOC: To remove the search box from the sidebar you just need to completely remove the below "sidebar-search-wrapper" LI element -->
                             <li class="nav-item start"  id="0">
                                <a href="/resturant" class="nav-link">
                                    <i class="icon-home"></i>
                                    <span class="title">Dashboard</span>
                                </a>
                          </li> 
                          <li class="nav-item start"  id="1">
                                <a href="/resturant/useroffer/list" class="nav-link">
                          ...
                          <a href="javascript:;" class="nav-link nav-toggle">
                               ...
                               <ul class="sub-menu">
                                  ...
                                  <li  class="nav-item  " id="5_3"> <a href="/resturant/resturant"  class="nav-link "><span class="title">My Details</span></a></li>
                                  <li  class="nav-item  " id="5_4"> <a href="/resturant/resturant_images"  class="nav-link "><span class="title">Restaurant Images</span></a></li>
                                  <li  class="nav-item  " id="5_5"> <a href="/resturant/resturant_menu"  class="nav-link "><span class="title">Restaurant Menu</span></a></li>
                                                          

                             </ul>
                          </li>
                            <li class="nav-item start"  id="2">
                                <a href="/resturant/unsubscribe" class="nav-link">
                            ...
                            <li class="nav-item"  id="7">
                                ...
                                <ul class="sub-menu">
                                    <li class="nav-item  " id="7_0"><a href="/resturant/useroffer/trans" class="nav-link "><span class="title">Coupons</span></a></li>
                                </ul>
                            </li>
