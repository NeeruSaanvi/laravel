...
<div class="page-bar">
 ...
 <!-- END PAGE BAR -->
  <!-- BEGIN PAGE TITLE-->
  <h1 class="page-title"> Transaction History
  </h1>
  <!-- END PAGE TITLE-->
     <!-- END PAGE HEADER-->
        ...
        <div class="row">
         <div class="col-sm-12">
            <div class="portlet-body form">
                <form class="form-material form-horizontal" method="get" action="/resturant/useroffer/trans">
    ...
    <div class="portlet box blue">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-globe"></i>Transaction History</div>
            <div class="tools"> </div>
        </div>
