     ...
     <!-- END PAGE HEADER-->
		 ...
		 <div class="col-sm-12">
            <div class="portlet-body form">
                @if($action!='edit')
                    <form class="form-horizontal" method="post" action="/resturant/resturant_menu"  enctype="multipart/form-data">
                @else
                    <form class="form-horizontal" method="post" action="/resturant/resturant_menu/{{$resturant->id}}"  enctype="multipart/form-data">
                @endif
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input name="price" class="form-control validate[custom[onlyNumberSp]]" value="{{old('price')?e(old('price')):$resturant->price}}"  required>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" cellspacing="0" width="100%">
                ...
                <tbody>
                   ...
                   <tr>
                    ...
                    <td>
                        <a href="/resturant/resturant_menu/delete/{{ $rest->id }}"> <i class="fa fa-trash"></i></a>
                         &nbsp;&nbsp; |&nbsp;&nbsp;
                        <a href="/resturant/resturant_menu/{{ $rest->id }}" class="text-info"> <i class="fa fa-pencil"></i></a></td>
                  </tr>
                    @endforeach
                    @if($i==0)
                   <tr>
                    <td colspan="4" align="center">No Menu Found</td>
                    </tr>
