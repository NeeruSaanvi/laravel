 ...
 <!-- END PAGE BAR -->
  ...
  <!-- END PAGE TITLE-->
     ...
     <div class="row">
        <div class="col-sm-12">
          <div class="white-box">
             <form class="form-material form-horizontal" method="post" action="/user/change_pwd">
                <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">     
                <div class="form-group">
                      <label class="col-md-12" for="title">Old Password</span></label>
                      <div class="col-md-12">
                          <input type="password" placeholder="Old Password" class="form-control validate[required]" name="oldpassword"
                           required>
                      </div>
                  </div>
                  <div class="form-group">
                      ...
                      <div class="col-md-12">
                          <input type="password" placeholder="New Password" class="form-control validate[required,custom[password]]" name="password"
