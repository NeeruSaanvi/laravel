...
<head>
   ...
   <link href="https://fonts.googleapis.com/css?family=Libre+Baskerville" rel="stylesheet">
	...
	<link rel="stylesheet" type="text/css" href="<?php echo e(url('css/slick-theme.css')); ?>">
	...
	<script src="<?php echo e(url('js/modernizr.js')); ?>"></script> <!-- Modernizr -->
...
<body>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-3 col-xs-5">
							<a href="/"><img src="<?php echo e(url('img/logo.png')); ?>" alt="logo" class="img-responsive"></a>
						</div>
						<div class="hidden-md hidden-lg col-sm-7 col-xs-7">
							<div class="menu">
								<a id="toggler" href="javascript:void(0)">
								<img class="barss" src="<?php echo e(url('img/micon.png')); ?>" width="15"/> 
								<img class="close-bar" src="<?php echo e(url('img/close.png')); ?>" width="15"  />
								</a>
								<ul class="main-menu1">
									<li><a href="<?php echo e(url('who-we-are')); ?>"> Who We Are</a></li>
									<li><a href="<?php echo e(url('works')); ?>"> How It Works</a></li>
									<li><a href="<?php if(Auth::check()): ?>	<?php echo e(url('browse')); ?> <?php else: ?> <?php echo e(url('login')); ?> <?php endif; ?>"> Browse Restaurants & Bars</a></li>
									<li><a href="<?php echo e(url('faq')); ?>"> Faq</a></li>
									<?php if(Auth::check()): ?>
										<?php if(Auth::user()->role=='User'): ?>
										<li><a href="/user">Welcome, <?php echo e(Auth::user()->name); ?></a>
										<ul class="sub-menu">
										...
										<li><a href="/admin">Welcome, <?php echo e(Auth::user()->name); ?></a></li>
										<?php else: ?>
										<li><a href="/resturant">Welcome, <?php echo e(Auth::user()->name); ?></a></li>
										<?php endif; ?>
									<?php else: ?>
									<li><a href="<?php echo e(url('login')); ?>"> Log In</a></li>
									<li><a href="<?php echo e(url('user-register-step-1')); ?>"> Join</a></li>
									<?php endif; ?>
								</ul>
							</div>
						</div>
						<div class="col-md-9 hidden-xs hidden-sm">
							<ul class="main-menu">
								<li><a href="<?php echo e(url('who-we-are')); ?>" class="hvr-outline-in"> Who We Are</a></li>
								<li><a href="<?php echo e(url('works')); ?>" class="hvr-outline-in"> How It Works</a></li>
								<li><a href="<?php if(Auth::check()): ?>	<?php echo e(url('browse')); ?> <?php else: ?> <?php echo e(url('login')); ?> <?php endif; ?>" class="hvr-outline-in"> Browse Restaurants & Bars</a></li>
								<li><a href="<?php echo e(url('faq')); ?>" class="hvr-outline-in"> Faq</a></li>
								<?php if(Auth::check()): ?>
										<?php if(Auth::user()->role=='User'): ?>
										<li><a href="/user">Welcome, <?php echo e(Auth::user()->name); ?></a>
										<ul class="sub-menu">
			...
			<footer>
				<div class="container">
					<div class="col-md-3">
						<img src="<?php echo e(url('img/logo.png')); ?>" alt="logo" class="img-responsive">
...
<script src="<?php echo e(url('js/jquery-2.1.4.js')); ?>"></script>
<script src="<?php echo e(url('js/bootstrap.min.js')); ?>"></script>
<script src="<?php echo e(url('js/slick.js')); ?>"></script>
<script src="<?php echo e(url('js/jquery.viewportchecker.min.js')); ?>"></script> 
